...
export default function Error({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-2xl font-black text-white italic tracking-tighter uppercase mb-2">System Interrupted</h2>
      <p className="text-zinc-500 text-sm max-w-md mb-10 leading-relaxed font-medium">
        A diagnostic exception occurred. The connection has been temporarily paused.
      </p>
